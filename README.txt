 ...
 * Run composer to install the dependencies:
   composer require 'drupal/social_auth_digitalocean'
...
User can click on the DigitalOcean logo in the Social Auth Login block.
...
user to DigitalOcean for authentication. DigitalOcean then returns the user
to Drupal site. If we have an existing Drupal user with the same email address
provided by DigitalOcean, that user is logged in. Otherwise a new Drupal user
is created.
