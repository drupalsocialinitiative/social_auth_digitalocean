...
class DigitalOceanAuthController extends OAuth2ControllerBase {
  ...
  public function __construct(MessengerInterface $messenger,
    ...
    parent::__construct('Social Auth DigitalOcean', 'social_auth_digitalocean', $messenger, $network_manager, $user_authenticator, $digitalocean_manager, $request, $data_handler);
  }
  ...
  public function callback() {
    ...
    if ($profile !== NULL) {
      ...
      return $this->userAuthenticator->authenticateUser($profile->getId(), $profile->getEmail(), $profile->getId(), $this->providerManager->getAccessToken(), FALSE, $data);
    }
